...
def main():
    ...
    dlc: dict[str, str] = dict(dlblue = '#0096ff', dlorange = '#FF9300', dldarkred='#C00000', dlmagenta='#FF40FF', dlpurple='#7030A0', dldarkblue =  '#0D5BDC')
    dlblue: str = '#0096ff'
    dlorange: str = '#FF9300'
    ...
    utl.plt_train_test(X_train, y_train, X_test, y_test, x, y_pred, x_ideal, y_ideal, degree)
    ...
    utl.plt_optimal_degree(
        X_train, y_train, X_cv, y_cv, x, y_pred, x_ideal, y_ideal, 
    ...
    plt.close("all")
    utl.plt_tune_regularization(X_train, y_train, X_cv, y_cv, x, y_pred, err_train, err_cv, optimal_reg_idx, lambda_range)
    ...
    X_train, y_train, X_cv, y_cv, x, y_pred, err_train, err_cv, m_range, degree = utl.tune_m()
    utl.plt_tune_m(X_train, y_train, X_cv, y_cv, x, y_pred, err_train, err_cv, m_range, degree)
    ...
    utl.plt_nn(model_predict, X_train, y_train, classes, X_cv, y_cv, suptitle="Complex Model")
